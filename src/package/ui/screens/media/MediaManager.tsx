...
// eslint-disable-next-line no-restricted-imports -- P2c 迁移期保留 model，P4 提取通用媒体控制器后删除。
import { useMediaManager } from '@/features/media/model/useMediaManager';
import { MediaHeader } from './MediaHeader';
import { MediaGrid } from './MediaGrid';
import { MediaDetails } from './MediaDetails';
// eslint-disable-next-line no-restricted-imports -- P2c 迁移期保留 model，P4 提取通用媒体控制器后删除。
import { similarMatchLabel } from '@/features/media/model/findSimilarMediaAssets';
