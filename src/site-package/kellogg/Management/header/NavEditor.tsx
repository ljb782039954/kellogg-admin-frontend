                  ...
                  <div className="mt-4 pt-4 border-t border-dashed border-gray-300 pl-4 border-l-2 border-l-blue-200">
                    ...
                    <div className="space-y-3 flex-1 grid grid-cols-1 md:grid-cols-2 gap-3" >
                      {item.children?.map((subItem, subIndex) => (
                        <div key={subItem.id || subIndex} className="flex gap-3 bg-white p-3 rounded border border-green-300 shadow-sm">
                          ...
                          <Button variant="ghost" size="sm" onClick={() => removeSubItem(index, subIndex)} className="text-red-500 mt-6 h-8 w-8 p-0">
                             <Trash2 className="w-4 h-4" />
                          </Button>
                        </div>
                      ))}
